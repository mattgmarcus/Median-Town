...
base_url = "http://dartmouth.smartcatalogiq.com/en/2013/orc/Departments-Programs-Undergraduate/"
...
def makeRegex(pair):
    if 2 == len(pair):
        return r"/en/2013/orc/Departments-Programs-Undergraduate/" + pair[1] + r"/" + pair[0] + "-" + pair[1] + r"/\w+-[0-9]+-*[0-9]*"
    elif 3 == len(pair):
        return r"/en/2013/orc/Departments-Programs-Undergraduate/" + pair[1] + r"/" + pair[2] + r"/\w+-[0-9]+-*[0-9]*"
    else:
        print "What was put in?"
        return None
